...
const billingFaq: { q: string; a: string }[] = [
    ...
    { q: "Are prices in Jamaican dollars?", a: "Prices are set in US dollars so they stay stable. Your card is charged the Jamaican-dollar equivalent at the day's exchange rate, and you see the exact J$ amount before you pay." },

...
//     return (
//         <div className={styles.contDiv} style={{ display: "grid", alignContent: "flex-start", backgroundColor: "var(--bg2)", }}>
//             <button className='button4' style={{ justifySelf: "flex-end" }}
//                 onClick={() => {
...
//             <div style={{ display: userInteracting ? "grid" : "none", alignContent: "flex-start", padding: "var(--spacingR)", gap: "var(--spacingR)", border: "1px solid var(--shade1)", overflow: "auto", width: canFloat ? "min(300px, 80vw)" : "", justifyItems: "center", zIndex: 999 }}>
...
//                         return (
//                             <button key={eachOtherSelectionOption} className='button2' style={{ backgroundColor: eachOtherSelectionOption === activeSelection.current ? "var(--color1)" : "" }}
//                                 onClick={async () => {
//                                     try {
//                                         //update active selection
...
//                             return (
//                                 <button key={eachFilterOption} className='button3' style={{ backgroundColor: eachFilterOption === filter ? "var(--color1)" : "" }}
//                                     onClick={() => {
...
//                 <div style={{ display: "grid", alignContent: "flex-start", gap: "var(--spacingR)", justifySelf: "flex-start" }}>
//                     <div style={{ display: "flex", alignItems: "center", justifySelf: "stretch", overflow: "auto" }}>
...
//                     {previewTemplate !== null && (
//                         <div style={{ display: "flex", gap: "var(--spacingS)", alignItems: "center", justifySelf: "stretch", overflow: "auto" }}>
//                             <button className='button1'
//                                 onClick={async () => {
//                                     try {
